# Generated by Django 3.0.2 on 2020-01-27 04:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homeworld', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_star_wars.Planet')),
                ('people', models.ManyToManyField(related_name='species', to='app_star_wars.People')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='people',
            name='homeworld',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='residents', to='app_star_wars.Planet'),
        ),
        migrations.CreateModel(
            name='Hero',
            fields=[
                ...
                ('edited', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=100)),
                ('homeworld', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='heroes', to='app_star_wars.Planet')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='Vehicle',
            fields=[
                ('transport_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='app_star_wars.Transport')),
                ('vehicle_class', models.CharField(max_length=40)),
                ('pilots', models.ManyToManyField(blank=True, related_name='vehicles', to='app_star_wars.People')),
            ],
            options={
                'abstract': False,
            },
            bases=('app_star_wars.transport',),
        ),
        migrations.CreateModel(
            name='Starship',
            fields=[
                ...
                ('pilots', models.ManyToManyField(blank=True, related_name='starships', to='app_star_wars.People')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('characters', models.ManyToManyField(blank=True, related_name='films', to='app_star_wars.People')),
                ('planets', models.ManyToManyField(blank=True, related_name='films', to='app_star_wars.Planet')),
                ('species', models.ManyToManyField(blank=True, related_name='films', to='app_star_wars.Species')),
                ('starships', models.ManyToManyField(blank=True, related_name='films', to='app_star_wars.Starship')),
                ('vehicles', models.ManyToManyField(blank=True, related_name='films', to='app_star_wars.Vehicle')),
            ],
            options={
                'abstract': False,
            },
